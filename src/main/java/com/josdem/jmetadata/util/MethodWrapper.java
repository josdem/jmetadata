...
public class MethodWrapper<T> {
  ...
  public class UsingMethodWrapper<X> {
    ...
    public X invoke(Object... param) {
      try {
        ...
        log.error(
            e.getMessage(), new RuntimeException("The method has just exploded in your face"));
        return null;
      }
    }
  }
  ...
  private static class MethodWrapperBuilder
      implements MethodWrapperBuilderPhase1,
          MethodWrapperBuilderPhase2,
