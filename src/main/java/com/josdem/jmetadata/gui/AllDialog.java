...
/**
 * @understands This class decorates the dialog borders avoiding code duplication in every
 *     dialog</br> </br> <b>Note:</b> Call {@code initializeContentPane()} in the contructor of
 *     every subclass but before setting the dialog visible
 */
public abstract class AllDialog extends JDialog {
  ...
  /**
   * Call this method from the classes which extends this, after initialize all their components and
