...
public class LoginWindow {
  ...
  private static final Color COLOR_SELECTION_TEXTFIELDS =
      SelectedTextForeground.SELECTED_FOREGROUND_COLOR;
  private static final Icon BULLET_ICON =
      UIManager.getDefaults().getIcon("icons.createAccountBullet");
  private static final int REQUIRE_ICON_TEXT_GAP = 2;

  @Autowired private ViewEngineConfigurator configurator;
