...
import com.josdem.jmetadata.gui.util.SynthIcons;
...
class DescriptionTableHeaderCellRenderer implements TableCellRenderer {
  ...
  private void setLabelAlignment(String columnName, JLabel label) {
    ...
    if (columnName.equals("Plays")
        || columnName.equals("Time")
        || columnName.equals("Bitrate")
        || columnName.equals("Size")
        || columnName.equals("Skips")) {
