...
public class DragTooltipDialog extends JDialog {
  ...
  public enum IconType {
    Folder("folders", "dragFolder", Object.class, 14, 14),
    Playlist("playlists", "dragPlaylist", Object.class, 14, 14),
    Track("tracks", "dragTrack", Object.class, 14, 14),
    Download("downloads", "dragTrack", Object.class, 14, 14),
    Contact("contacts", "dragContacts", Object.class, 7, 14) {
      @Override
  ...
  private DynamicPanel getDynamicPanel(IconType type, List<?> list) {
    ...
    String text =
        list.isEmpty() ? null : (list.size()) + " " + (type == null ? "ERROR" : type.getText());
    if (list.size() == 1) {
