...
public final class FileDragSource implements DragGestureListener, DragSourceListener {
  ...
  public static void addDragSource(Component c, FileSelection modelSelection) {
    ...
    // Do not change ACTION_COPY or else only pain and misery will follow you until the end of time.
    // JAVA DnDrops sux.
    // Big Time
  ...
  public void dragGestureRecognized(DragGestureEvent dge) {
    ...
    if (draggedItems != null && !draggedItems.isEmpty()) {
      Transferable t =
          new FileTransferable(fileSelection.isFromExternalDevices(dragOrigin), draggedItems);
      try {
