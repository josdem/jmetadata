...
@Slf4j
@Service
public class MultiLayerDropTargetListener extends DropTargetAdapter
    implements Observer<ObservValue<Component>> {
  private static boolean lastDropSuccess;

  private DnDListenerCollection<DropListener> dropListeners =
      new DnDListenerCollection<DropListener>();

  private DnDListenerCollection<DragOverListener> dragListeners =
      new DnDListenerCollection<DragOverListener>();
