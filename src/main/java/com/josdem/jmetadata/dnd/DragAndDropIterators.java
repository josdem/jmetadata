...
public class DragAndDropIterators {
  ...
  public static DoInListeners<Void, DragOverListener> dragEnter(
      Point point, DraggedObject draggedObject, boolean validationResult, Container currentFrame) {
  ...
  public static DoInListeners<Void, DragOverListener> updateLocation(
  ...
  public static DoInListeners<Boolean, DropListener> doDrop(
      Point point, DraggedObject draggedObject, Container currentFrame) {
    return new DoDropIterator(point, draggedObject, currentFrame);
  }

  public static DoInListeners<Boolean, DropListener> validateDrop(
      DraggedObject draggedObject, Point point, Container currentFrame) {
  ...
  private static final class UpdateLocationIterator
      extends DoInListenersAdapter<Void, DragOverListener> {
    private final Point point;
    private final Container currentFrame;
  ...
  private static final class DropOcurredIterator
      extends DoInListenersAdapter<Void, DragOverListener> {
  ...
  private static final class ValidateDropIterator
      extends DoInListenersAdapter<Boolean, DropListener> {
    private final DraggedObject draggedObject;
    private final Point point;
    private final Container currentFrame;
  ...
  private static final class DragAllowedChangedIterator
      extends DoInListenersAdapter<Void, DragOverListener> {
    private final boolean validationResult;
  ...
  private static Point convertToComponentRelativePoint(
      Point location, Container currentFrame, Component component) {
