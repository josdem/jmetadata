...
public class TableDownloadSelectedHeaderPanelPainter extends SynthPainter {
  private static final float[] FRACTIONS = {
    0.360f, 0.4506f, 0.5073f, 0.5558f, 0.5996f, 0.6402f, 0.6785f, 0.7149f, 0.7497f, 0.7833f,
    0.8158f, 0.8474f, 0.8780f, 0.9080f, 0.9372f, 0.9658f, 0.994f
  };

  private static final Color[] COLORS = {
    new Color(0x5a, 0x5a, 0x5a),
    new Color(0x60, 0x60, 0x60),
    new Color(0x67, 0x67, 0x67),
    new Color(0x6e, 0x6e, 0x6e),
    new Color(0x75, 0x75, 0x75),
    new Color(0x7c, 0x7c, 0x7c),
    new Color(0x83, 0x83, 0x83),
    new Color(0x8a, 0x8a, 0x8a),
    new Color(0x91, 0x91, 0x91),
    new Color(0x97, 0x97, 0x97),
    new Color(0x9e, 0x9e, 0x9e),
    new Color(0xa5, 0xa5, 0xa5),
    new Color(0xac, 0xac, 0xac),
    new Color(0xb3, 0xb3, 0xb3),
  ...
  public void paintPanelBackground(SynthContext context, Graphics g, int x, int y, int w, int h) {
    LinearGradientPaint gradientPaint =
        new LinearGradientPaint(67.00f, 25.08f, 67.00f, -11.50f, FRACTIONS, COLORS);
