...
public class ProgressBarPainterAlwaysEnabled extends SynthPainter {
  ...
  private static final float borderFractions[] = {
  ...
  private LinearGradientPaint getBorderGradientPaint() {
    LinearGradientPaint gradientPaint =
        new LinearGradientPaint(70.00f, 11.95f, 70.00f, -8.46f, borderFractions, borderColors);
  ...
  private LinearGradientPaint getBrightInGrayProgressGradientPaint() {
    LinearGradientPaint gradientPaint =
        new LinearGradientPaint(70.00f, 3.94f, 70.00f, -7.00f, fractions, colors);
    return gradientPaint;
  }

  private LinearGradientPaint getGrayProgressGradientPaint() {
    LinearGradientPaint gradientPaint =
        new LinearGradientPaint(69.00f, 11.00f, 69.00f, -9.77f, fractions, colors);
    return gradientPaint;
  }
}
