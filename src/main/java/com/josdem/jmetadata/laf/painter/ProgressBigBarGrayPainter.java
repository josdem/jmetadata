...
public class ProgressBigBarGrayPainter extends SynthPainter {
  ...
  private final LinearGradientPaint thumbBackgroundGradientOne =
      new LinearGradientPaint(
          69.00f,
          9.33f,
          69.00f,
          -1.67f,
          new float[] {0.000f, 1.000f},
          new Color[] {Color.WHITE, new Color(0x22, 0x1f, 0x1f)});

  private final LinearGradientPaint thumbBackgroundGradientTwo =
      new LinearGradientPaint(
          69.00f,
          3.50f,
          69.00f,
          -10.14f,
          new float[] {0.000f, 1.000f},
          new Color[] {Color.WHITE, new Color(0x32, 0x32, 0x32)});
