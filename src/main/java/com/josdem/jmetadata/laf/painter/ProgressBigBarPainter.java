...
public class ProgressBigBarPainter extends SynthPainter {
  ...
  protected LinearGradientPaint getBorderGradientPaint() {
    ...
    LinearGradientPaint gradientPaint =
        new LinearGradientPaint(70.00f, 13.17f, 70.00f, -11.32f, fractions, colors);
  ...
  protected LinearGradientPaint getPurpleProgressGradientPaint() {
    ...
    LinearGradientPaint gradientPaint =
        new LinearGradientPaint(69.00f, 9.31f, 69.00f, -7.24f, fractions, colors);
    return gradientPaint;
  }
