...
public class ProgressBarPainter extends SynthPainter {
  ...
  public void paintSliderThumbBackground(
    ...
    g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
    g2.setPaint(
        slider.isEnabled() ? getPurpleProgressGradientPaint() : getGrayProgressGradientPaint());
    g2.fill(getProgressPath(slider));
    g2.setPaint(
        slider.isEnabled()
            ? getBrightInPurpleProgressGradientPaint()
            : getBrightInGrayProgressGradientPaint());
  ...
  protected LinearGradientPaint getBorderGradientPaint() {
    float fractions[] = {
      0.000f, 0.0553f, 0.1111f, 0.1673f, 0.2240f, 0.2814f, 0.3393f, 0.3979f, 0.4573f, 0.5176f,
    ...
    Color colors[] = {
      ...
      new Color(0xd5, 0xd5, 0xd5),
      new Color(0xc8, 0xc7, 0xc7),
      new Color(0xba, 0xb9, 0xb9),
      new Color(0xac, 0xab, 0xab),
      new Color(0x9e, 0x9d, 0x9d),
      new Color(0x91, 0x8f, 0x8f),
      new Color(0x83, 0x81, 0x81),
      new Color(0x75, 0x73, 0x73),
      new Color(0x67, 0x65, 0x65),
      new Color(0x5a, 0x57, 0x57),
      new Color(0x4c, 0x49, 0x49),
      new Color(0x3e, 0x3b, 0x3b),
      new Color(0x30, 0x2d, 0x2d),
      new Color(0x23, 0x1f, 0x20)
    };
    LinearGradientPaint gradientPaint =
        new LinearGradientPaint(70.00f, 11.95f, 70.00f, -8.46f, fractions, colors);
    return gradientPaint;
  }

  protected LinearGradientPaint getPurpleProgressGradientPaint() {
    float fractions[] = {
      0.000f, 0.0418f, 0.0845f, 0.1283f, 0.1732f, 0.2194f, 0.2671f, 0.3164f, 0.3676f, 0.4210f,
      0.4771f, 0.5365f, 0.6001f, 0.6694f, 0.7471f, 0.8401f, 1.000f
    };
    Color colors[] = {
      new Color(0xb8, 0x0, 0xb8),
      new Color(0xaf, 0x1, 0xb0),
      new Color(0xa6, 0x2, 0xa8),
      new Color(0x9d, 0x3, 0xa1),
      new Color(0x94, 0x4, 0x99),
      new Color(0x8b, 0x5, 0x91),
      new Color(0x82, 0x6, 0x8a),
      new Color(0x79, 0x7, 0x82),
      new Color(0x71, 0x8, 0x7b),
      new Color(0x68, 0x9, 0x73),
      new Color(0x5f, 0xa, 0x6b),
      new Color(0x56, 0xb, 0x64),
      new Color(0x4d, 0xc, 0x5c),
      new Color(0x44, 0xd, 0x54),
      new Color(0x3b, 0xe, 0x4d),
      new Color(0x32, 0xf, 0x45),
      new Color(0x2a, 0x11, 0x3e)
    };
    LinearGradientPaint gradientPaint =
        new LinearGradientPaint(44.00f, 10.31f, 44.00f, 1.43f, fractions, colors);
    return gradientPaint;
  }
  ...
  protected GeneralPath getProgressPath(JSlider slider) {
    ...
    if (fillValue >= slider.getWidth() - curveGap) {
      ...
      gp.curveTo(
          ...
          sliderHeight / 2.0);
      gp.curveTo(
          sliderWidth - border, gap, sliderWidth - gap, border, sliderWidth - 2 * gap, border);
    }
    gp.closePath();
    return gp;
  }
  ...
  protected LinearGradientPaint getBrightInPurpleProgressGradientPaint() {
    ...
    Color colors[] = {
      new Color(0x4d, 0x15, 0x5c), new Color(0x85, 0x65, 0x90), new Color(0xd1, 0xc9, 0xd8)
    };
    LinearGradientPaint gradientPaint =
        new LinearGradientPaint(44.25f, 6.33f, 44.25f, 0.50f, fractions, colors);
    return gradientPaint;
  }
  ...
  private LinearGradientPaint getDisabledBorderGradientPaint() {
    ...
    Color colors[] = {
      Color.WHITE,
      new Color(0xfb, 0xfb, 0xfb),
      new Color(0xf8, 0xf8, 0xf8),
      new Color(0xf4, 0xf4, 0xf4),
      new Color(0xf1, 0xf1, 0xf1),
      new Color(0xed, 0xed, 0xed),
      new Color(0xea, 0xea, 0xea),
  ...
  private LinearGradientPaint getGrayProgressGradientPaint() {
    ...
    Color colors[] = {
      ...
      new Color(0xce, 0xce, 0xce),
      new Color(0xc8, 0xc8, 0xc8),
      new Color(0xc3, 0xc3, 0xc3),
      new Color(0xbd, 0xbd, 0xbd),
      new Color(0xb7, 0xb7, 0xb7),
      new Color(0xb2, 0xb2, 0xb2),
      new Color(0xac, 0xac, 0xac),
      new Color(0xa6, 0xa6, 0xa6),
      new Color(0xa1, 0xa1, 0xa1),
      new Color(0x9b, 0x9b, 0x9b),
      new Color(0x96, 0x96, 0x96)
    };
    LinearGradientPaint gradientPaint =
        new LinearGradientPaint(70.00f, 10.31f, 70.00f, 1.43f, fractions, colors);
    return gradientPaint;
  }
  ...
  private LinearGradientPaint getBrightInGrayProgressGradientPaint() {
    ...
    Color colors[] = {
      new Color(0x78, 0x78, 0x78), new Color(0xb4, 0xb4, 0xb4), new Color(0xe6, 0xe6, 0xe6)
    };
    LinearGradientPaint gradientPaint =
        new LinearGradientPaint(70.00f, 6.33f, 70.00f, 0.50f, fractions, colors);
    return gradientPaint;
  }
}
