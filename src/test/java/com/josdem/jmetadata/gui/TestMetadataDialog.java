...
class TestMetadataDialog {
  ...
  @Mock private ControlEngineConfigurator controlEngineConfigurator;
  @Mock private ControlEngine controlEngine;
  @Mock private MetadataHelper metadataHelper;
  @Mock private MetadataAlbumValues metadataAlbumValues;
  ...
  public void shouldSetAlbumValues() throws Exception {
    ...
    if (!Environment.isLinux()) {
      ...
      MetadataDialog metadataDialog =
          new MetadataDialog(mainWindow, controlEngineConfigurator, message);
      ...
      verify(controlEngine)
          .fireEvent(
              Events.READY_TO_APPLY, new ValueEvent<MetadataAlbumValues>(metadataAlbumValues));
    }
  }
